...
WITH anchor_seed(canonical_name, name, description, workout_type, training_zone, workout_category, distance, estimated_duration, is_interval, is_test) AS (
  VALUES
    ...
    ('2 min @ 20 SPM, 2 min @ 22, 2 min @ 24, 2 min @ 22, 2 min @ 20', 'Session 1', 'Session 1 anchor from KB training plan seed.', 'erg', 'UT1', 'rate_control', NULL, 10, false, false),
    ('2 min @ 20, 2 min @ 22, 2 min @ 24, 1 min @ 26, 2 min @ 24, 2 min @ 22, 2 min @ 20', 'Session 1', 'Session 1 anchor from KB training plan seed.', 'erg', 'UT1', 'rate_control', NULL, 13, false, false),
    ('2 min @ 20, 2 min @ 22, 2 min @ 24, 2 min @ 24, 2 min @ 22, 2 min @ 20', 'Session 1', 'Session 1 anchor from KB training plan seed.', 'erg', 'UT1', 'rate_control', NULL, 12, false, false),
    ('2 min @ 20, 2 min @ 22, 2 min @ 24, 2 min @ 26, 2 min @ 24, 2 min @ 22, 2 min @ 20', 'Session 1', 'Session 1 anchor from KB training plan seed.', 'erg', 'UT1', 'rate_control', NULL, 14, false, false),
    ...
    ('3 min @ 20, 2 min @ 22, 1 min @ 24, 1 min @ 26, 1 min @ 24, 2 min @ 22, 3 min @ 20', 'Session 1', 'Session 1 anchor from KB training plan seed.', 'erg', 'UT1', 'rate_control', NULL, 13, false, false),
    ('3 min @ 20, 3 min @ 22, 2 min @ 24, 3 min @ 22, 3 min @ 20', 'Session 1', 'Session 1 anchor from KB training plan seed.', 'erg', 'UT1', 'rate_control', NULL, 14, false, false),
    ('3 min @ 20, 3 min @ 22, 3 min @ 24, 3 min @ 22, 3 min @ 20', 'Session 1', 'Session 1 anchor from KB training plan seed.', 'erg', 'UT1', 'rate_control', NULL, 15, false, false),
...
SELECT
  ...
  'beginner',
  a.workout_category IN ('steady_state', 'cross_training', 'rate_control'),
