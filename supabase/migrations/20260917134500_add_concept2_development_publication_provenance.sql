-- Preserve provider-side provenance for every future development publication.
-- The local publication row remains the authoritative mapping; the comment makes
-- the LC identity visible in the Concept2 Logbook record itself.
