-- Extend only the service-role development claim for saved general manual RowErg summaries.
 ...
 if p_action='list' then
  ...
  if w.raw_data->>'source' = 'concept2_development_fixture' then
   ...
   if w.source is distinct from 'manual' or w.workout_type is distinct from 'row'
    ...
    or general_result->>'detailCoverage' is distinct from 'none'
    ...
    or round(w.duration_seconds*10) is distinct from w.duration_seconds*10
